 ...
 *
 * Chapter and topic navigation below a subject, listing the content items in each.
 *
  ...
  return (
    <ScrollView contentContainerStyle={[styles.scroll, { paddingTop: insets.top + spacing.lg }]}>
      ...
      <GlassCard>
        ...
        <Text style={styles.body}>Chapter and topic navigation below a subject, listing the content items in each.</Text>
