...
/**
 * Schools — not built yet.
 *
 * Add, edit, activate and deactivate schools, and view their students and code allocation.
 *
  ...
  return (
    <ScrollView contentContainerStyle={[styles.scroll, { paddingTop: insets.top + spacing.lg }]}>
      ...
      <GlassCard>
        ...
        <Text style={styles.body}>Add, edit, activate and deactivate schools, and view their students and code allocation.</Text>
        <View style={styles.list}>
          <Text style={styles.endpoint}>GET    /api/schools</Text>
          <Text style={styles.endpoint}>GET    /api/schools/:id</Text>
          <Text style={styles.endpoint}>POST   /api/schools</Text>
          <Text style={styles.endpoint}>PUT    /api/schools/:id</Text>
          <Text style={styles.endpoint}>PATCH  /api/schools/:id/status</Text>
        </View>
